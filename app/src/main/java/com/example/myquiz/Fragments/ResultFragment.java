...
public class ResultFragment extends Fragment implements View.OnClickListener {
    ...
    TextView correctanswer, wronganswers, percentage, missedanswers;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        correctanswer = view.findViewById(R.id.results_correct_text);
        ...
        toHomebtn = view.findViewById(R.id.results_home_btn);
        ...
        firebaseFirestore.collection("QuizList")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    correctanswer.setText(answerofcorrect.toString());
                    wronganswers.setText(inccorectanswer.toString());
