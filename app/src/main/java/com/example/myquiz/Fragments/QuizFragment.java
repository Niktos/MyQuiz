...
import com.example.myquiz.Model.QuestionsModel;
...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    List<QuestionsModel> allQuestionList = new ArrayList<>();
    List<QuestionsModel> questionToAnswer = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("QuizList").document(String.valueOf(quizid)).collection("Questions")
        ...
        }); // смена переменных обрати внимание при проблеме сюда
    ...
    private void startTimer(int questNum) {
        ...
        countDownTimer = new CountDownTimer(timeToAnswer * 1000, 10) {
            ...
            public void onFinish() {
                ...
                canAnswer = false;
                answerFeedbackText.setText("Your time is over");
    ...
    private void submitResult() {
        ...
        firebaseFirestore.collection("QuizList").document(quizid).collection("Results").document(currentUserId)
    ...
    private void showNextButton() {
        ...
        if (currentQuestion == totalNumberOfQuestions) {
            ...
            nextButton.setText("Go to Result");
